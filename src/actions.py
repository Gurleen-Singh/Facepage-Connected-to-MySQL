...
class Actions(object):
    ...
    def queryNodes(self, indexes=False, apimodule=False, options=False):
        ...
        try:
            ...
            gur = apimodule.fetchData(job['data'], job['options'])
            #print '\n',self.mainWindow.RequestTabs.currentWidget(),'\n'
            r = update();
            g = r.fetchData(job['data'], job['options'])
            print 'i am g',g
            ...
            while True:
                try:
                    ...
                    #-Add data...
                        ...
                        treenode.appendNodes(nodedata, job['data'], job['options'], job['headers'], True)
                        #show status
