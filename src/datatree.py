...
class TreeItem(object):
    ...
    def appendNodes(self, nodedata, data, options, headers=None, delaycommit=False):
        ...
        def appendNode(objecttype, objectid, response):
            ...
            Sqldatabase.addData(objectid, objecttype, new.response, new.querystatus, new.querytime, new.querytype,new.parent_id)
            newnodes.append(new)
